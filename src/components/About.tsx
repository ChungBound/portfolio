...
const skills = [
  {
    icon: Code,
    title: "Languages",
    description: "JavaScript (ES6+), TypeScript, Python, Java, PHP, SQL, C/C++",
  },
  {
    icon: Globe,
    title: "Frameworks & Libraries",
    description:
      "Vue.js, React, Next.js, FastAPI, Node.js, Symfony, Spring Boot",
  },
  {
    icon: Database,
    title: "Tools & Technologies",
    description: "MySQL, Cordova, Redis, Docker, Git, Nginx, Tailwind CSS",
  },
  {
    icon: Smartphone,

            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white/5 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-100 placeholder-gray-600 dark:placeholder-gray-300 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 transition-colors duration-200 [&:-webkit-autofill]:bg-white/5 dark:[&:-webkit-autofill]:bg-gray-800/50 [&:-webkit-autofill]:text-gray-900 dark:[&:-webkit-autofill]:text-gray-100"
              ...
              >
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 bg-white/5 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-100 placeholder-gray-600 dark:placeholder-gray-300 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 transition-colors duration-200 resize-none"
